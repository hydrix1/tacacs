...
%define libsdocdir %{?_pkgdocdir:%(echo %{_pkgdocdir} | sed -e s,krb5,krb5-libs-static,g)}%{!?_pkgdocdir:%{_docdir}/%{name}-libs-static-%{version}}
...
Patch326: krb5-1.12.2-staticprofile.patch
...
%package libs-static
Summary: The static libraries used by Kerberos 5
Group: System Environment/Libraries
%if 0%{?rhel} == 6
...
%patch326 -p1 -b .krb5-1.12.2-staticprofile
...
%post libs-static -p /sbin/ldconfig

%if 0%{?configure_default_ccache_name}
%triggerun libs-static -- krb5-libs < 1.11.3-16
...
%postun libs-static -p /sbin/ldconfig
...
%files libs-static -f %{gettext_domain}.lang
%defattr(-,root,root,-)
%doc README NOTICE
