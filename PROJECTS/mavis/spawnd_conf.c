 ...
 * All rights reserved.
 *
 * $Id: spawnd_conf.c,v 1.59 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: spawnd_conf.c,v 1.59 2015/03/14 06:11:28 marc Exp marc $";
