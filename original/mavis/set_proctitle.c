 ...
 * All rights reserved.
 *
 * $Id: set_proctitle.c,v 1.12 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: set_proctitle.c,v 1.12 2015/03/14 06:11:28 marc Exp marc $";
