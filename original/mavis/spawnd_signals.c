 ...
 *
 * $Id: spawnd_signals.c,v 1.20 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: spawnd_signals.c,v 1.20 2015/03/14 06:11:28 marc Exp marc $";
