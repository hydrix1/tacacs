 ...
 * All rights reserved.
 *
 * $Id: mavistest.c,v 1.25 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: mavistest.c,v 1.25 2015/03/14 06:11:28 marc Exp marc $";
