 ...
 * All rights reserved.
 *
 * $Id: libmavis_asciiftp.c,v 1.16 2015/03/14 06:11:27 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_asciiftp.c,v 1.16 2015/03/14 06:11:27 marc Exp marc $";
...
struct module_defn mod_asciiftp = 
{
    .name = MAVIS_name,
    .new =  Mavis_new,
    .append = Mavis_append, 
