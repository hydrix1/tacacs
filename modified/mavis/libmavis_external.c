 ...
 * All rights reserved.
 * 
 * $Id: libmavis_external.c,v 1.68 2015/03/14 06:11:27 marc Exp marc $
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_external.c,v 1.68 2015/03/14 06:11:27 marc Exp marc $";
...
struct module_defn mod_external = 
{
    .name = MAVIS_name,
    .new =  Mavis_new,
    .append = Mavis_append, 
