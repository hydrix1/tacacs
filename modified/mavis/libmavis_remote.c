 ...
 * All rights reserved.
 *
 * $Id: libmavis_remote.c,v 1.27 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_remote.c,v 1.27 2015/03/14 06:11:28 marc Exp marc $";
