 ...
 * All rights reserved.
 *
 * $Id: libmavis_anonftp.c,v 1.19 2015/03/14 06:11:27 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_anonftp.c,v 1.19 2015/03/14 06:11:27 marc Exp marc $";
