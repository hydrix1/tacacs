 ...
 * All rights reserved.
 *
 * $Id: spawnd_accepted.c,v 1.35 2015/03/14 06:11:28 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: spawnd_accepted.c,v 1.35 2015/03/14 06:11:28 marc Exp marc $";
